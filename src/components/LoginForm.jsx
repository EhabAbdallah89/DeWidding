function LoginForm({ loginData, onChange, onSubmit, errorMessage, successMessage }) {
  return (
    <div className="card">
      <h3 className="section-title">تسجيل الدخول برقم الهاتف وكلمة المرور</h3>
      <div className="grid-2">
        <div className="field"><label>رقم الهاتف</label><input type="text" name="phone" value={loginData.phone} onChange={onChange} placeholder="05XXXXXXXX" /></div>
